...
#define DEFAULT_SPEAKER_VOLUME         18
...
#if ENABLE_WIFI
/* Enable WiFi audio dump by setting this define on 1 */
#define ENABLE_WIFI_AUDIO_DUMP         0

#if ENABLE_WIFI_AUDIO_DUMP
/* Choose protocol for sending data */
#define DUMP_OVER_TCP                  1
#define DUMP_OVER_UDP                  0

/* Set this to 1 to export all audio streams, otherwise only clean stream will be exported */
#define DUMP_ALL_STREAMS               0
